...
abstract class AbstractModelImporter
{
    ...
    protected function setDefaultValue(&$value, $key)
    {
        if($value != "")
        {
            ...
            else $this->default_data[$key] = $value;
        }
    }
    ...
    {
        if($model_instance->exists && !$this->overwrite) return $model_instance;
    ...
    protected function getInjectedValue($local_column, $row)
    {
           ...
           array_key_exists($local_column, $this->injected_data_pairs))
        {
            ...
            if(!is_null($injected_values)) return $injected_values[$local_column];
        }
        return null;
    }
     ...
     * @return MessageBag
     */
    public function errors() { return $this->errorMessageBag; }

    /**
     * Return validation error messages
     * @return MessageBag
     */
    public function validationErrors() { return $this->validationMessageBag; }
     ...
     * @return int
     */
    public function getImported() { return $this->num_imported; }
     ...
     * @return string[]
     */
    public function getDefaultValues() { return $this->default_data; }
